...
<div class="container mt-3">
  <div class="row ">
    <div class="col-4">
        <ul>
          <li><a href="#intro" class="text-primary">Intro</a></li>
          <li><a href="#visi" class="text-dark">Visi</a></li>
          <li><a href="#misi" class="text-dark">Misi</a></li>
          
        </ul>
    </div>
    <div class="col-8">
       <h3 id="intro">Visi & Misi</h3>
       <img src="image/profil2.png" alt="gambar" style="width: 45rem">
       <p class="mt-2">LSP Teknologi digital didirikan oleh Asosiasi, praktisi dan akademisi yang sudah berkecimpung lama di Sistem Sertifikasi Nasional. Pengalaman yang empiris dan harapan besar untuk mengantarkan Indonesia menjadi negara maju melalui SDM yang kompeten dan tersertifikasi, LSP TD akan terus komitmen, kontinyu dan konsisten menerapkan Sistem Manajemen Mutu pengelolaan Lembaga Sertifikasi. </p>

       <h3 id="visi">Visi</h3>
        <p>Menjadikan Lembaga Sertifikasi Profesi bidang teknologi informasi yang profesional, kredibel, akuntabel dan terkini dalam pengembangan dan perlindungan sumberdaya manusia</p>
